        ...
        <div className='presentation'>
            <div className='presentation_container'>
                <div className='presentation_container_text'>
                    ...
                    <p className='presentation_container_text_speech'>Our team of mad scientists will meet your craziest expectations. A clever mix of intelligence and ham is the basis of our secret recipe.Imagine your dream vacation and we will implant it directly in your memory. Travel without getting tired.</p>
                    <Link to="/tontrip">
                        <button className='presentation_container_text_btn'>I realize my dream now !</button>
                    </Link>
                </div>
            ...
            <div className='presentation_container'>
                ...
                <div className='presentation_container_text'>
                    ...
                    <Link to="/tontrip">
                        <button className='presentation_container_text_btn'>Make me cry !</button>
                    </Link>
                </div>
            </div>
            ...
            <div className='presentation_container'>
                <div className='presentation_container_text'>
                    ...
                    <Link to="/tontrip">
                        <button className='presentation_container_text_btn'>I want the same !</button>
                    </Link>
                </div>
                <div className='presentation_container_slider'>
                    <Slider3 />
